...
export const env = {
  ...
  /**
   * Assistant de création de trajet (depuis v0.7.0). Tout optionnel :
   *   - GEOCODER_BASE_URL : instance Nominatim (search + reverse) utilisée par
   *     la création d'adresse (propositions avec numéros de rue). Défaut = instance
  ...
  GEO_USER_AGENT: optional(
    "GEO_USER_AGENT",
    "TeslaMateFix/0.7.0 (+https://github.com/kerkeniw/TeslaMateFix)",
  ),
